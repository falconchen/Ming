<div class="install">
    ...
    <div class="demoinstall">
        ...
        <p>Install is not necessary but will help you to get the core pages, categories,
        ...
        IT WILL MOST CERTAINLY DESTROY YOUR PAST WORK.</span></p>
    ...
    <div class="skipinstall">
        ...
        <h3>Skip Import</h3>
        <p>Skipping the instalation will not install the core pages and categories. Further more the meta setup and all the settings will be done manually.
        <br /><br />
        <span>NOTE: WE RECOMMEND SKIPPING THE INSTALL ONLY IF YOU HAVE WORDPRESS SKILLS  AND KNOW HOW TO MANUALLY INSTALL THE TEMPLATE</span></p>
