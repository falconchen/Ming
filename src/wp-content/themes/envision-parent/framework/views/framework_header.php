    ...
    <div id="tfuse_header_theme_info">
        ...
        <div id="tfuse_header_text">
            ...
            <div id="tfuse_header_theme_links">
                <a target="_blank" href="<?php echo $this->theme->manual_url; ?>">Online documentation</a>&nbsp;&nbsp;<span>
                    |</span>&nbsp;&nbsp;<a target="_blank" href="<?php echo $this->theme->forum_url; ?>">Support Forums</a>
            </div>
        </div>
