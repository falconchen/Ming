         ...
         */
        {
            ...
            foreach ($placeholders_css as $placeholder => $css_arr) {
                foreach ($css_arr as $css) {
                    ...
                    $to_out[$placeholder] .= "\n".'<link rel="stylesheet" href="'. $css['link'] .'?ver='. esc_attr($css['version']) .'" type="text/css" media="all" />';
         ...
         */
        {
            ...
            foreach ($placeholders_js as $placeholder => $js_arr) {
                foreach ($js_arr as $js) {
                    $to_out[$placeholder] .= "\n" . '<script type="text/javascript" src="'. $js['link'] .'?ver='. esc_attr($js['version']) .'"></script>';
                }
            }
        }
